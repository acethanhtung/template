      ...
      008186 81               [ 4]   84 	ret
                                     ...
                                     88 ;	-----------------------------------------
      008187                         89 _TIM4_TimeBaseInit:
                                     90 ;	lib/src/stm8s_tim4.c: 70: TIM4->PSCR = (uint8_t)(TIM4_Prescaler);
      008187 AE 53 47         [ 2]   91 	ldw	x, #0x5347
      00818A 7B 03            [ 1]   92 	ld	a, (0x03, sp)
      00818C F7               [ 1]   93 	ld	(x), a
                                     94 ;	lib/src/stm8s_tim4.c: 72: TIM4->ARR = (uint8_t)(TIM4_Period);
      00818D AE 53 48         [ 2]   95 	ldw	x, #0x5348
      008190 7B 04            [ 1]   96 	ld	a, (0x04, sp)
      008192 F7               [ 1]   97 	ld	(x), a
      ...
      008193 81               [ 4]   99 	ret
                                    ...
                                    103 ;	-----------------------------------------
      008194                        104 _TIM4_Cmd:
                                    105 ;	lib/src/stm8s_tim4.c: 89: TIM4->CR1 |= TIM4_CR1_CEN;
      008194 C6 53 40         [ 1]  106 	ld	a, 0x5340
                                    107 ;	lib/src/stm8s_tim4.c: 87: if (NewState != DISABLE)
      008197 0D 03            [ 1]  108 	tnz	(0x03, sp)
      008199 27 06            [ 1]  109 	jreq	00102$
                                    110 ;	lib/src/stm8s_tim4.c: 89: TIM4->CR1 |= TIM4_CR1_CEN;
      00819B AA 01            [ 1]  111 	or	a, #0x01
      00819D C7 53 40         [ 1]  112 	ld	0x5340, a
      0081A0 81               [ 4]  113 	ret
      0081A1                        114 00102$:
                                    115 ;	lib/src/stm8s_tim4.c: 93: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_CEN);
      0081A1 A4 FE            [ 1]  116 	and	a, #0xfe
      0081A3 C7 53 40         [ 1]  117 	ld	0x5340, a
      ...
      0081A6 81               [ 4]  119 	ret
                                    ...
                                    123 ;	-----------------------------------------
      0081A7                        124 _TIM4_ITConfig:
      0081A7 88               [ 1]  125 	push	a
                                    126 ;	lib/src/stm8s_tim4.c: 116: TIM4->IER |= (uint8_t)TIM4_IT;
      0081A8 C6 53 43         [ 1]  127 	ld	a, 0x5343
                                    128 ;	lib/src/stm8s_tim4.c: 113: if (NewState != DISABLE)
      0081AB 0D 05            [ 1]  129 	tnz	(0x05, sp)
      0081AD 27 07            [ 1]  130 	jreq	00102$
                                    131 ;	lib/src/stm8s_tim4.c: 116: TIM4->IER |= (uint8_t)TIM4_IT;
      0081AF 1A 04            [ 1]  132 	or	a, (0x04, sp)
      0081B1 C7 53 43         [ 1]  133 	ld	0x5343, a
      0081B4 20 0C            [ 2]  134 	jra	00104$
      0081B6                        135 00102$:
                                    136 ;	lib/src/stm8s_tim4.c: 121: TIM4->IER &= (uint8_t)(~TIM4_IT);
      0081B6 88               [ 1]  137 	push	a
      0081B7 7B 05            [ 1]  138 	ld	a, (0x05, sp)
      0081B9 43               [ 1]  139 	cpl	a
      0081BA 6B 02            [ 1]  140 	ld	(0x02, sp), a
      0081BC 84               [ 1]  141 	pop	a
      0081BD 14 01            [ 1]  142 	and	a, (0x01, sp)
      0081BF C7 53 43         [ 1]  143 	ld	0x5343, a
      0081C2                        144 00104$:
                                    145 ;	lib/src/stm8s_tim4.c: 123: }
      0081C2 84               [ 1]  146 	pop	a
      0081C3 81               [ 4]  147 	ret
                                    148 ;	lib/src/stm8s_tim4.c: 131: void TIM4_UpdateDisableConfig(FunctionalState NewState)
                                    149 ;	-----------------------------------------
                                    150 ;	 function TIM4_UpdateDisableConfig
                                    151 ;	-----------------------------------------
      0081C4                        152 _TIM4_UpdateDisableConfig:
                                    153 ;	lib/src/stm8s_tim4.c: 139: TIM4->CR1 |= TIM4_CR1_UDIS;
      0081C4 C6 53 40         [ 1]  154 	ld	a, 0x5340
                                    155 ;	lib/src/stm8s_tim4.c: 137: if (NewState != DISABLE)
      0081C7 0D 03            [ 1]  156 	tnz	(0x03, sp)
      0081C9 27 06            [ 1]  157 	jreq	00102$
                                    158 ;	lib/src/stm8s_tim4.c: 139: TIM4->CR1 |= TIM4_CR1_UDIS;
      0081CB AA 02            [ 1]  159 	or	a, #0x02
      0081CD C7 53 40         [ 1]  160 	ld	0x5340, a
      0081D0 81               [ 4]  161 	ret
      0081D1                        162 00102$:
                                    163 ;	lib/src/stm8s_tim4.c: 143: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_UDIS);
      0081D1 A4 FD            [ 1]  164 	and	a, #0xfd
      0081D3 C7 53 40         [ 1]  165 	ld	0x5340, a
      ...
      0081D6 81               [ 4]  167 	ret
                                    ...
                                    171 ;	-----------------------------------------
      0081D7                        172 _TIM4_UpdateRequestConfig:
                                    173 ;	lib/src/stm8s_tim4.c: 163: TIM4->CR1 |= TIM4_CR1_URS;
      0081D7 C6 53 40         [ 1]  174 	ld	a, 0x5340
                                    175 ;	lib/src/stm8s_tim4.c: 161: if (TIM4_UpdateSource != TIM4_UPDATESOURCE_GLOBAL)
      0081DA 0D 03            [ 1]  176 	tnz	(0x03, sp)
      0081DC 27 06            [ 1]  177 	jreq	00102$
                                    178 ;	lib/src/stm8s_tim4.c: 163: TIM4->CR1 |= TIM4_CR1_URS;
      0081DE AA 04            [ 1]  179 	or	a, #0x04
      0081E0 C7 53 40         [ 1]  180 	ld	0x5340, a
      0081E3 81               [ 4]  181 	ret
      0081E4                        182 00102$:
                                    183 ;	lib/src/stm8s_tim4.c: 167: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_URS);
      0081E4 A4 FB            [ 1]  184 	and	a, #0xfb
      0081E6 C7 53 40         [ 1]  185 	ld	0x5340, a
      ...
      0081E9 81               [ 4]  187 	ret
                                    ...
                                    191 ;	-----------------------------------------
      0081EA                        192 _TIM4_SelectOnePulseMode:
                                    193 ;	lib/src/stm8s_tim4.c: 187: TIM4->CR1 |= TIM4_CR1_OPM;
      0081EA C6 53 40         [ 1]  194 	ld	a, 0x5340
                                    195 ;	lib/src/stm8s_tim4.c: 185: if (TIM4_OPMode != TIM4_OPMODE_REPETITIVE)
      0081ED 0D 03            [ 1]  196 	tnz	(0x03, sp)
      0081EF 27 06            [ 1]  197 	jreq	00102$
                                    198 ;	lib/src/stm8s_tim4.c: 187: TIM4->CR1 |= TIM4_CR1_OPM;
      0081F1 AA 08            [ 1]  199 	or	a, #0x08
      0081F3 C7 53 40         [ 1]  200 	ld	0x5340, a
      0081F6 81               [ 4]  201 	ret
      0081F7                        202 00102$:
                                    203 ;	lib/src/stm8s_tim4.c: 191: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_OPM);
      0081F7 A4 F7            [ 1]  204 	and	a, #0xf7
      0081F9 C7 53 40         [ 1]  205 	ld	0x5340, a
      ...
      0081FC 81               [ 4]  207 	ret
                                    ...
                                    211 ;	-----------------------------------------
      0081FD                        212 _TIM4_PrescalerConfig:
                                    213 ;	lib/src/stm8s_tim4.c: 222: TIM4->PSCR = (uint8_t)Prescaler;
      0081FD AE 53 47         [ 2]  214 	ldw	x, #0x5347
      008200 7B 03            [ 1]  215 	ld	a, (0x03, sp)
      008202 F7               [ 1]  216 	ld	(x), a
                                    217 ;	lib/src/stm8s_tim4.c: 225: TIM4->EGR = (uint8_t)TIM4_PSCReloadMode;
      008203 AE 53 45         [ 2]  218 	ldw	x, #0x5345
      008206 7B 04            [ 1]  219 	ld	a, (0x04, sp)
      008208 F7               [ 1]  220 	ld	(x), a
      ...
      008209 81               [ 4]  222 	ret
                                    ...
                                    226 ;	-----------------------------------------
      00820A                        227 _TIM4_ARRPreloadConfig:
                                    228 ;	lib/src/stm8s_tim4.c: 242: TIM4->CR1 |= TIM4_CR1_ARPE;
      00820A C6 53 40         [ 1]  229 	ld	a, 0x5340
                                    230 ;	lib/src/stm8s_tim4.c: 240: if (NewState != DISABLE)
      00820D 0D 03            [ 1]  231 	tnz	(0x03, sp)
      00820F 27 06            [ 1]  232 	jreq	00102$
                                    233 ;	lib/src/stm8s_tim4.c: 242: TIM4->CR1 |= TIM4_CR1_ARPE;
      008211 AA 80            [ 1]  234 	or	a, #0x80
      008213 C7 53 40         [ 1]  235 	ld	0x5340, a
      008216 81               [ 4]  236 	ret
      008217                        237 00102$:
                                    238 ;	lib/src/stm8s_tim4.c: 246: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_ARPE);
      008217 A4 7F            [ 1]  239 	and	a, #0x7f
      008219 C7 53 40         [ 1]  240 	ld	0x5340, a
      ...
      00821C 81               [ 4]  242 	ret
                                    ...
                                    246 ;	-----------------------------------------
      00821D                        247 _TIM4_GenerateEvent:
                                    248 ;	lib/src/stm8s_tim4.c: 263: TIM4->EGR = (uint8_t)(TIM4_EventSource);
      00821D AE 53 45         [ 2]  249 	ldw	x, #0x5345
      008220 7B 03            [ 1]  250 	ld	a, (0x03, sp)
      008222 F7               [ 1]  251 	ld	(x), a
      ...
      008223 81               [ 4]  253 	ret
                                    ...
                                    257 ;	-----------------------------------------
      008224                        258 _TIM4_SetCounter:
                                    259 ;	lib/src/stm8s_tim4.c: 275: TIM4->CNTR = (uint8_t)(Counter);
      008224 AE 53 46         [ 2]  260 	ldw	x, #0x5346
      008227 7B 03            [ 1]  261 	ld	a, (0x03, sp)
      008229 F7               [ 1]  262 	ld	(x), a
      ...
      00822A 81               [ 4]  264 	ret
                                    ...
                                    268 ;	-----------------------------------------
      00822B                        269 _TIM4_SetAutoreload:
                                    270 ;	lib/src/stm8s_tim4.c: 287: TIM4->ARR = (uint8_t)(Autoreload);
      00822B AE 53 48         [ 2]  271 	ldw	x, #0x5348
      00822E 7B 03            [ 1]  272 	ld	a, (0x03, sp)
      008230 F7               [ 1]  273 	ld	(x), a
      ...
      008231 81               [ 4]  275 	ret
                                    ...
                                    279 ;	-----------------------------------------
      008232                        280 _TIM4_GetCounter:
                                    281 ;	lib/src/stm8s_tim4.c: 298: return (uint8_t)(TIM4->CNTR);
      008232 C6 53 46         [ 1]  282 	ld	a, 0x5346
      ...
      008239 81               [ 4]  293 	ret
                                    ...
                                    297 ;	-----------------------------------------
      00823A                        298 _TIM4_GetFlagStatus:
                                    299 ;	lib/src/stm8s_tim4.c: 326: if ((TIM4->SR1 & (uint8_t)TIM4_FLAG)  != 0)
      00823A C6 53 44         [ 1]  300 	ld	a, 0x5344
      00823D 14 03            [ 1]  301 	and	a, (0x03, sp)
      00823F 27 03            [ 1]  302 	jreq	00102$
                                    303 ;	lib/src/stm8s_tim4.c: 328: bitstatus = SET;
      008241 A6 01            [ 1]  304 	ld	a, #0x01
      008243 81               [ 4]  305 	ret
      008244                        306 00102$:
                                    307 ;	lib/src/stm8s_tim4.c: 332: bitstatus = RESET;
      008244 4F               [ 1]  308 	clr	a
      ...
      008245 81               [ 4]  311 	ret
                                    ...
                                    315 ;	-----------------------------------------
      008246                        316 _TIM4_ClearFlag:
                                    317 ;	lib/src/stm8s_tim4.c: 350: TIM4->SR1 = (uint8_t)(~TIM4_FLAG);
      008246 7B 03            [ 1]  318 	ld	a, (0x03, sp)
      008248 43               [ 1]  319 	cpl	a
      008249 C7 53 44         [ 1]  320 	ld	0x5344, a
